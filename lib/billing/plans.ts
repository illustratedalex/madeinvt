...
export const billingPlans: BillingPlan[] = [
  {
    ...
    active: true,
    purchasable: false,
    description: "A no-cost listing with the core MadeInVT directory presence.",
    trustNote: "This plan does not purchase editorial recommendations, verification, rankings, or MadeInVT Recommended status.",
  },
  {
    id: "enhanced_monthly",
    ...
    trustNote: "Paid business listing upgrades do not purchase editorial recommendations, verification, rankings, or MadeInVT Recommended status.",
  ...
  },
  {
    ...
    active: true,
    purchasable: true,
    description: "Early-supporter recognition during beta with a closer relationship to MadeInVT.",
    trustNote: "Founding Partner support does not purchase editorial recommendations, verification, rankings, or MadeInVT Recommended status.",
