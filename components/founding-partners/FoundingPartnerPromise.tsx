...
export function FoundingPartnerPromise() {
  return (
    <EditorialSection
      ...
      description="The founding offer supports growth, but it does not change how MadeInVT reports or recommends."
    >
      <Prose>
        <ul className="space-y-3">
          ...
          <li><strong>MadeInVT Recommended</strong> is earned through trust, not payment.</li>
        </ul>
      </Prose>
    </EditorialSection>
  );
